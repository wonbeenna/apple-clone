  ...
  function playAnimation() {
    ...
    switch (currentScene) {
      ...
      case 3:
        ...
        // 캔버스가 브라우저 상단에 닿지 않으면 step = 1 닿으면 2
        if (scrollRatio < values.rect1X[2].end) {
          ...
          if (
            ...
            objs.canvasCaption.style.transform = `translate3d(0, ${alcValues(
              values.canvasCaption_transformY,
              currentYOffset
            )}%, 0)`;
          }
        }
